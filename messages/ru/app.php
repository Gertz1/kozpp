...
return [
    ...
    'To use this feature, you need to log in' => 'Для использования этой функции необходимо авторизоваться',
    'About' => 'О нас',
    'Contact' => 'Контакты',
    'Login' => 'Войти',
    'Logout' => 'Выход',
    ...
    'Patronymic' => 'Отчество',
    'Sign Up' => 'Регистрация',
    'If you have business inquiries or other questions, please fill out the following form to contact us.' => 'Если у вас есть деловое предложение или другие вопросы , пожалуйста, заполните следующую форму, чтобы связаться с нами . Cпасибо',
    'The above error occurred while the Web server was processing your request.' => 'При обработке Вашего запроса произошла ошибка на веб-сервере .',
    'Please contact us if you think this is a server error. Thank you.' => 'Пожалуйста, сообщите нам об этой ошибке. Спасибо.',
